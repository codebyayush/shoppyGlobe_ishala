      ...
      <div className="flex justify-center screen-max-9:pt-16 pt-32 screen-max-6:w-fit screen-max-6:h-fit screen-max-12:flex-col screen-max-12:items-center bg-gray-900 min-h-screen p-5">
        ...
        <div className="screen-max-6:pt-40 screen-max-9:pt-52 screen-max-12:w-[500px] p-4 screen-max-7:w-auto">
          <img
            src={images[0]}
            alt="product-image"
            className="max-w-[500px] max-h-[500px]  screen-max-7:h-[300px] screen-max-7:w-[300px] p-5 m-auto bg-white shadow-lg"
          />
        </div>

        {/* product Details */}
        {product && (
          <div className="h-fit w-[500px] screen-max-12:w-auto text-white screen-max-12:mt-20 ml-16 screen-max-12:ml-5">
            <div>
              ...
              <div className="mt-5">
                ...
                <span className="ml-2 text-sm line-through text-gray-400">
                  {/* used the logic to get the actual price using discount percentage*/}
              ...
              <div className="mt-5">
                ...
                <div className="mt-3 space-y-3">
                  {reviews.map((review, index) => (
                    <div
                      key={index}
                      className="bg-gray-800 p-4 rounded-lg screen-max-6:w-auto"
                    >
